...
timezone conversion, legacy function aliases, and Domo-valid block/line comments.
...
| `fixtures/beast-modes.json` | Raw Domo SQL for 38 formulas (36 card formulas + two dataset-level comment regressions) |
