...
| domo/beast-mode-matrix | 36 live-shaped cards + date/comment/text regressions + 2 source-invalid formulas | converter/DM/workbook placement matrix + fail-closed checks |
